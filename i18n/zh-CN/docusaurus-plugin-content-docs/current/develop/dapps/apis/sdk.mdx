...
| [getgems-io/ton-grpc](https://github.com/getgems-io/ton-grpc) | Tonlib binary | tonlibjson 的 Rust 绑定（因此取决于 TON monorepo 中的二进制文件）以及在其基础上构建的服务 |
...
| [tongo](https://github.com/tonkeeper/tongo)              | Native ADNL | TON 区块链库的 Go 实现         |
...
| [olifanton/ton](https://github.com/olifanton/ton)                           | PHP    | 通过 RPC ([Orbs](https://www.orbs.com/ton-access/) / [Toncenter](https://toncenter.com/api/v2/) / 等) | PHP SDK 包含一套标准原语和合约。                         |   |
