...
<Button href="/develop/dapps/telegram-apps/" colorType={'primary'} sizeType={'sm'}>Build a TMA</Button>
<Button href="/develop/dapps/apis/sdk" colorType="secondary" sizeType={'sm'}>Choose an SDK</Button>
