...
<Button href="https://stepik.org/course/176754/" colorType={'secondary'} sizeType={'sm'}>TON Blockchain Course</Button>
<Button href="https://tonspeedrun.com/" colorType={'secondary'} sizeType={'sm'}>TON Speed Run Tutorials</Button>
