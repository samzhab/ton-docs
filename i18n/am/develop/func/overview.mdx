...
<Button href="/develop/func/cookbook" colorType={'primary'} sizeType={'sm'}>FunC Cookbook</Button>
<Button href="/develop/func/types" colorType={'secondary'} sizeType={'sm'}>FunC Documentation</Button>
